...
<body>
    ...
    <div class="content">        
        <div class="box-content left w100">
            ...
            <div class="box-metricas">
                <div class="box-metrica-single">
                    <div class="box-metrica-wraper">
                        ...
                        <p>10</p>
                    </div><!-- fim box-metrica-wraper -->
                </div><!-- fim box-metrica-single -->
            ...
            </div><!-- fim box-metricas -->
        </div><!-- fim box-contente -->
